    ...
    data() {
        return {
            ...
            typing : [{'name': 'スズメ', 'img': '@/assets/0.jpg'}, 
                ...
                {'name': 'ヤマガラ', 'img': '@/assets/11.jpg'}, 
                {'name': 'ツグミ', 'img': '@/assets/12.jpg'}, 
                {'name': 'ヒヨドリ', 'img': '@/assets/13.jpg'}, 
                ...
                {'name': 'イソヒヨ', 'img': '@/assets/21.jpg'},
                {'name': 'アトリ', 'img': '@/assets/22.jpg'},
                {'name': 'シジュウカラ', 'img': '@/assets/23.jpg'},
                {'name': 'ウグイス', 'img': '@/assets/24.jpg'},
